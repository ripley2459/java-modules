// java wrapper for vtkQuadraticLinearWedge object
//
...
public class vtkQuadraticLinearWedge extends vtkNonLinearCell
{
  ...
  public vtkQuadraticLinearWedge() { super(); }

  public vtkQuadraticLinearWedge(long id) { super(id); }
