// java wrapper for vtkPDataSetReader object
//
...
public class vtkPDataSetReader extends vtkDataSetAlgorithm
{
  ...
  public vtkPDataSetReader() { super(); }

  public vtkPDataSetReader(long id) { super(id); }
