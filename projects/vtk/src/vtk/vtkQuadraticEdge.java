// java wrapper for vtkQuadraticEdge object
//
...
public class vtkQuadraticEdge extends vtkNonLinearCell
{
  ...
  public vtkQuadraticEdge() { super(); }

  public vtkQuadraticEdge(long id) { super(id); }
