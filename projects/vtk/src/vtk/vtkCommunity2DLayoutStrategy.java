// java wrapper for vtkCommunity2DLayoutStrategy object
//
...
public class vtkCommunity2DLayoutStrategy extends vtkGraphLayoutStrategy
{
  ...
  private native byte[] GetCommunityArrayName_29();
  public String GetCommunityArrayName()
  {
    return new String(GetCommunityArrayName_29(), StandardCharsets.UTF_8);
  }

  private native void SetCommunityArrayName_30(byte[] id0, int len0);
  public void SetCommunityArrayName(String id0)
  {
    byte[] bytes0 = id0.getBytes(StandardCharsets.UTF_8);
    SetCommunityArrayName_30(bytes0, bytes0.length);
  }

  private native void SetCommunityStrength_31(float id0);
  public void SetCommunityStrength(float id0)
  {
    SetCommunityStrength_31(id0);
  }

  private native float GetCommunityStrengthMinValue_32();
  public float GetCommunityStrengthMinValue()
  {
    return GetCommunityStrengthMinValue_32();
  }

  private native float GetCommunityStrengthMaxValue_33();
  public float GetCommunityStrengthMaxValue()
  {
    return GetCommunityStrengthMaxValue_33();
  }

  private native float GetCommunityStrength_34();
  public float GetCommunityStrength()
  {
    return GetCommunityStrength_34();
  }

  public vtkCommunity2DLayoutStrategy() { super(); }

  public vtkCommunity2DLayoutStrategy(long id) { super(id); }
