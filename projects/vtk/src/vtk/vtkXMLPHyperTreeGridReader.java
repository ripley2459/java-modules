// java wrapper for vtkXMLPHyperTreeGridReader object
//
...
public class vtkXMLPHyperTreeGridReader extends vtkXMLPDataObjectReader
{
  ...
  public vtkXMLPHyperTreeGridReader() { super(); }

  public vtkXMLPHyperTreeGridReader(long id) { super(id); }
