// java wrapper for vtkTriQuadraticHexahedron object
//
...
public class vtkTriQuadraticHexahedron extends vtkNonLinearCell
{
  ...
  public vtkTriQuadraticHexahedron() { super(); }

  public vtkTriQuadraticHexahedron(long id) { super(id); }
