// java wrapper for vtkRectilinearGridClip object
//
...
public class vtkRectilinearGridClip extends vtkRectilinearGridAlgorithm
{
  ...
  public vtkRectilinearGridClip() { super(); }

  public vtkRectilinearGridClip(long id) { super(id); }
