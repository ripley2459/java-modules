// java wrapper for vtkTableAlgorithm object
//
...
public class vtkTableAlgorithm extends vtkAlgorithm
{
  ...
  public vtkTableAlgorithm() { super(); }

  public vtkTableAlgorithm(long id) { super(id); }
