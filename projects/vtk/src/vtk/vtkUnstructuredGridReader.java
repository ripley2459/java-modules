// java wrapper for vtkUnstructuredGridReader object
//
...
public class vtkUnstructuredGridReader extends vtkDataReader
{
  ...
  private native void SetOutput_6(vtkUnstructuredGrid id0);
  public void SetOutput(vtkUnstructuredGrid id0)
  {
    SetOutput_6(id0);
  }
  ...
  public vtkUnstructuredGridReader() { super(); }

  public vtkUnstructuredGridReader(long id) { super(id); }
