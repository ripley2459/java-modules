// java wrapper for vtkHigherOrderCurve object
//
...
public class vtkHigherOrderCurve extends vtkNonLinearCell
{
  ...
  private native int GetOrder_19(int id0);
  public int GetOrder(int id0)
  {
    return GetOrder_19(id0);
  }

  private native boolean PointCountSupportsUniformOrder_20(long id0);
  public boolean PointCountSupportsUniformOrder(long id0)
  {
    return PointCountSupportsUniformOrder_20(id0);
  }

  private native int PointIndexFromIJK_21(int id0,int id1,int id2);
  public int PointIndexFromIJK(int id0,int id1,int id2)
  {
    return PointIndexFromIJK_21(id0,id1,id2);
  }

  public vtkHigherOrderCurve() { super(); }

  public vtkHigherOrderCurve(long id) { super(id); }
