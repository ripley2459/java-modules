// java wrapper for vtkSynchronizedTemplates3D object
//
...
public class vtkSynchronizedTemplates3D extends vtkPolyDataAlgorithm
{
  ...
  private native void ThreadedExecute_27(vtkImageData id0,vtkInformation id1,vtkInformation id2,vtkDataArray id3);
  public void ThreadedExecute(vtkImageData id0,vtkInformation id1,vtkInformation id2,vtkDataArray id3)
  {
    ThreadedExecute_27(id0,id1,id2,id3);
  }

  private native void SetInputMemoryLimit_28(long id0);
  public void SetInputMemoryLimit(long id0)
  {
    SetInputMemoryLimit_28(id0);
  }

  private native long GetInputMemoryLimit_29();
  public long GetInputMemoryLimit()
  {
    return GetInputMemoryLimit_29();
  }

  private native void SetArrayComponent_30(int id0);
  public void SetArrayComponent(int id0)
  {
    SetArrayComponent_30(id0);
  }

  private native int GetArrayComponent_31();
  public int GetArrayComponent()
  {
    return GetArrayComponent_31();
  }

  public vtkSynchronizedTemplates3D() { super(); }

  public vtkSynchronizedTemplates3D(long id) { super(id); }
