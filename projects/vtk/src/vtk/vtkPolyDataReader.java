// java wrapper for vtkPolyDataReader object
//
...
public class vtkPolyDataReader extends vtkDataReader
{
  ...
  private native void SetOutput_6(vtkPolyData id0);
  public void SetOutput(vtkPolyData id0)
  {
    SetOutput_6(id0);
  }
  ...
  public vtkPolyDataReader() { super(); }

  public vtkPolyDataReader(long id) { super(id); }
