// java wrapper for vtkCollapseGraph object
//
...
public class vtkCollapseGraph extends vtkGraphAlgorithm
{
  ...
  public vtkCollapseGraph() { super(); }

  public vtkCollapseGraph(long id) { super(id); }
