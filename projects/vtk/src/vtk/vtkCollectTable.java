// java wrapper for vtkCollectTable object
//
...
public class vtkCollectTable extends vtkTableAlgorithm
{
  ...
  public vtkCollectTable() { super(); }

  public vtkCollectTable(long id) { super(id); }
