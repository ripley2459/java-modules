// java wrapper for vtkXMLPImageDataReader object
//
...
public class vtkXMLPImageDataReader extends vtkXMLPStructuredDataReader
{
  ...
  public vtkXMLPImageDataReader() { super(); }

  public vtkXMLPImageDataReader(long id) { super(id); }
