// java wrapper for vtkRectilinearGridPartitioner object
//
...
public class vtkRectilinearGridPartitioner extends vtkMultiBlockDataSetAlgorithm
{
  ...
  public vtkRectilinearGridPartitioner() { super(); }

  public vtkRectilinearGridPartitioner(long id) { super(id); }
