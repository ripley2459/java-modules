// java wrapper for vtkHigherOrderTetra object
//
...
public class vtkHigherOrderTetra extends vtkNonLinearCell
{
  ...
  private native long ComputeOrder_21(long id0);
  public long ComputeOrder(long id0)
  {
    return ComputeOrder_21(id0);
  }

  private native boolean PointCountSupportsUniformOrder_22(long id0);
  public boolean PointCountSupportsUniformOrder(long id0)
  {
    return PointCountSupportsUniformOrder_22(id0);
  }

  private native long GetEdgeCell_23();
  public vtkHigherOrderCurve GetEdgeCell()
  {
    long temp = GetEdgeCell_23();

    if (temp == 0) return null;
    return (vtkHigherOrderCurve)vtkObjectBase.JAVA_OBJECT_MANAGER.getJavaObject(temp);
  }

  private native long GetFaceCell_24();
  public vtkHigherOrderTriangle GetFaceCell()
  {
    long temp = GetFaceCell_24();

    if (temp == 0) return null;
    return (vtkHigherOrderTriangle)vtkObjectBase.JAVA_OBJECT_MANAGER.getJavaObject(temp);
  }

  public vtkHigherOrderTetra() { super(); }

  public vtkHigherOrderTetra(long id) { super(id); }
