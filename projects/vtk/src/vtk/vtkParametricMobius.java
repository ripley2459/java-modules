// java wrapper for vtkParametricMobius object
//
...
public class vtkParametricMobius extends vtkParametricFunction
{
  ...
  public vtkParametricMobius() { super(); }

  public vtkParametricMobius(long id) { super(id); }
