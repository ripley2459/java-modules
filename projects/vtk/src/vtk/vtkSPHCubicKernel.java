// java wrapper for vtkSPHCubicKernel object
//
...
public class vtkSPHCubicKernel extends vtkSPHKernel
{
  ...
  public vtkSPHCubicKernel() { super(); }

  public vtkSPHCubicKernel(long id) { super(id); }
