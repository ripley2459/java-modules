// java wrapper for vtkParametricBour object
//
...
public class vtkParametricBour extends vtkParametricFunction
{
  ...
  public vtkParametricBour() { super(); }

  public vtkParametricBour(long id) { super(id); }
