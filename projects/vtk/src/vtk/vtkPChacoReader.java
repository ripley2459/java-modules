// java wrapper for vtkPChacoReader object
//
...
public class vtkPChacoReader extends vtkChacoReader
{
  ...
  public vtkPChacoReader() { super(); }

  public vtkPChacoReader(long id) { super(id); }
