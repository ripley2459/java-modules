// java wrapper for vtkTreeAlgorithm object
//
...
public class vtkTreeAlgorithm extends vtkAlgorithm
{
  ...
  public vtkTreeAlgorithm() { super(); }

  public vtkTreeAlgorithm(long id) { super(id); }
