// java wrapper for vtkCountVertices object
//
...
public class vtkCountVertices extends vtkPassInputTypeAlgorithm
{
  ...
  public vtkCountVertices() { super(); }

  public vtkCountVertices(long id) { super(id); }
