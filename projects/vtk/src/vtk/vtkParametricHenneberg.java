// java wrapper for vtkParametricHenneberg object
//
...
public class vtkParametricHenneberg extends vtkParametricFunction
{
  ...
  public vtkParametricHenneberg() { super(); }

  public vtkParametricHenneberg(long id) { super(id); }
