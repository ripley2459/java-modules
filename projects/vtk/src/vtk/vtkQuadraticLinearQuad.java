// java wrapper for vtkQuadraticLinearQuad object
//
...
public class vtkQuadraticLinearQuad extends vtkNonLinearCell
{
  ...
  public vtkQuadraticLinearQuad() { super(); }

  public vtkQuadraticLinearQuad(long id) { super(id); }
