// java wrapper for vtkSimple2DLayoutStrategy object
//
...
public class vtkSimple2DLayoutStrategy extends vtkGraphLayoutStrategy
{
  ...
  private native void SetJitter_24(boolean id0);
  public void SetJitter(boolean id0)
  {
    SetJitter_24(id0);
  }

  private native boolean GetJitter_25();
  ...
  public vtkSimple2DLayoutStrategy() { super(); }

  public vtkSimple2DLayoutStrategy(long id) { super(id); }
