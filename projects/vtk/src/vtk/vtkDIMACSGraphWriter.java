// java wrapper for vtkDIMACSGraphWriter object
//
...
public class vtkDIMACSGraphWriter extends vtkDataWriter
{
  ...
  public vtkDIMACSGraphWriter() { super(); }

  public vtkDIMACSGraphWriter(long id) { super(id); }
