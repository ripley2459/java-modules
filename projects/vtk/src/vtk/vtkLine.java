// java wrapper for vtkLine object
//
...
public class vtkLine extends vtkCell
{
  ...
  private native double DistanceToLine_16(double id0[],double id1[],double id2[]);
  public double DistanceToLine(double id0[],double id1[],double id2[])
  {
    return DistanceToLine_16(id0,id1,id2);
  }
  ...
  public vtkLine() { super(); }

  public vtkLine(long id) { super(id); }
