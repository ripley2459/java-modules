// java wrapper for vtkQuadraticHexahedron object
//
...
public class vtkQuadraticHexahedron extends vtkNonLinearCell
{
  ...
  public vtkQuadraticHexahedron() { super(); }

  public vtkQuadraticHexahedron(long id) { super(id); }
