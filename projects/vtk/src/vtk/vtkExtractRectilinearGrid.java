// java wrapper for vtkExtractRectilinearGrid object
//
...
public class vtkExtractRectilinearGrid extends vtkRectilinearGridAlgorithm
{
  ...
  public vtkExtractRectilinearGrid() { super(); }

  public vtkExtractRectilinearGrid(long id) { super(id); }
