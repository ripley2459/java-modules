// java wrapper for vtkExtractPolyDataPiece object
//
...
public class vtkExtractPolyDataPiece extends vtkPolyDataAlgorithm
{
  ...
  public vtkExtractPolyDataPiece() { super(); }

  public vtkExtractPolyDataPiece(long id) { super(id); }
