// java wrapper for vtkDataSetWriter object
//
...
public class vtkDataSetWriter extends vtkDataWriter
{
  ...
  public vtkDataSetWriter() { super(); }

  public vtkDataSetWriter(long id) { super(id); }
