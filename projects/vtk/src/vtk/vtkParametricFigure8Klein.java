// java wrapper for vtkParametricFigure8Klein object
//
...
public class vtkParametricFigure8Klein extends vtkParametricFunction
{
  ...
  public vtkParametricFigure8Klein() { super(); }

  public vtkParametricFigure8Klein(long id) { super(id); }
