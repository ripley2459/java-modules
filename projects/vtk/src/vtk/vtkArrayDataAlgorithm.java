// java wrapper for vtkArrayDataAlgorithm object
//
...
public class vtkArrayDataAlgorithm extends vtkAlgorithm
{
  ...
  public vtkArrayData GetOutput(int id0)
  {
  ...
  public vtkArrayDataAlgorithm() { super(); }

  public vtkArrayDataAlgorithm(long id) { super(id); }
