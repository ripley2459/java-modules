// java wrapper for vtkLagrangeTetra object
//
...
public class vtkLagrangeTetra extends vtkHigherOrderTetra
{
  ...
  public vtkLagrangeTetra() { super(); }

  public vtkLagrangeTetra(long id) { super(id); }
