// java wrapper for vtkExtractGrid object
//
...
public class vtkExtractGrid extends vtkStructuredGridAlgorithm
{
  ...
  public vtkExtractGrid() { super(); }

  public vtkExtractGrid(long id) { super(id); }
