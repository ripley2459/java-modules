// java wrapper for vtkXMLPHyperTreeGridWriter object
//
...
public class vtkXMLPHyperTreeGridWriter extends vtkXMLPDataObjectWriter
{
  ...
  public vtkXMLPHyperTreeGridWriter() { super(); }

  public vtkXMLPHyperTreeGridWriter(long id) { super(id); }
