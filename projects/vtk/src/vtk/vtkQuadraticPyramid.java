// java wrapper for vtkQuadraticPyramid object
//
...
public class vtkQuadraticPyramid extends vtkNonLinearCell
{
  ...
  public vtkQuadraticPyramid() { super(); }

  public vtkQuadraticPyramid(long id) { super(id); }
