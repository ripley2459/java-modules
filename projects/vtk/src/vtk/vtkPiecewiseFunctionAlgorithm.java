// java wrapper for vtkPiecewiseFunctionAlgorithm object
//
...
public class vtkPiecewiseFunctionAlgorithm extends vtkAlgorithm
{
  ...
  public vtkPiecewiseFunctionAlgorithm() { super(); }

  public vtkPiecewiseFunctionAlgorithm(long id) { super(id); }
