// java wrapper for vtkSelectionAlgorithm object
//
...
public class vtkSelectionAlgorithm extends vtkAlgorithm
{
  ...
  public vtkSelection GetOutput(int id0)
  {
  ...
  public vtkSelectionAlgorithm() { super(); }

  public vtkSelectionAlgorithm(long id) { super(id); }
