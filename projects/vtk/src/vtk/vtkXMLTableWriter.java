// java wrapper for vtkXMLTableWriter object
//
...
public class vtkXMLTableWriter extends vtkXMLWriter
{
  ...
  public vtkXMLTableWriter() { super(); }

  public vtkXMLTableWriter(long id) { super(id); }
