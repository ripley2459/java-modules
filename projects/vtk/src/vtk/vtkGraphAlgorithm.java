// java wrapper for vtkGraphAlgorithm object
//
...
public class vtkGraphAlgorithm extends vtkAlgorithm
{
  ...
  public vtkGraphAlgorithm() { super(); }

  public vtkGraphAlgorithm(long id) { super(id); }
