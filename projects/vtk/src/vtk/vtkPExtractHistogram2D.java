// java wrapper for vtkPExtractHistogram2D object
//
...
public class vtkPExtractHistogram2D extends vtkExtractHistogram2D
{
  ...
  public vtkPExtractHistogram2D() { super(); }

  public vtkPExtractHistogram2D(long id) { super(id); }
