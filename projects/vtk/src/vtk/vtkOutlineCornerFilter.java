// java wrapper for vtkOutlineCornerFilter object
//
...
public class vtkOutlineCornerFilter extends vtkPolyDataAlgorithm
{
  ...
  public vtkOutlineCornerFilter() { super(); }

  public vtkOutlineCornerFilter(long id) { super(id); }
