// java wrapper for vtkXMLPUniformGridAMRWriter object
//
...
public class vtkXMLPUniformGridAMRWriter extends vtkXMLUniformGridAMRWriter
{
  ...
  private native void SetWriteMetaFile_6(int id0);
  public void SetWriteMetaFile(int id0)
  {
    SetWriteMetaFile_6(id0);
  }

  public vtkXMLPUniformGridAMRWriter() { super(); }

  public vtkXMLPUniformGridAMRWriter(long id) { super(id); }
