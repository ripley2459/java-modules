// java wrapper for vtkAMReXGridReader object
//
...
public class vtkAMReXGridReader extends vtkAMRBaseReader
{
  ...
  public vtkAMReXGridReader() { super(); }

  public vtkAMReXGridReader(long id) { super(id); }
