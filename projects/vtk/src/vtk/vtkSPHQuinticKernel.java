// java wrapper for vtkSPHQuinticKernel object
//
...
public class vtkSPHQuinticKernel extends vtkSPHKernel
{
  ...
  public vtkSPHQuinticKernel() { super(); }

  public vtkSPHQuinticKernel(long id) { super(id); }
