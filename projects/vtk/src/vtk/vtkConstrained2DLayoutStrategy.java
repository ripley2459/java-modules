// java wrapper for vtkConstrained2DLayoutStrategy object
//
...
public class vtkConstrained2DLayoutStrategy extends vtkGraphLayoutStrategy
{
  ...
  private native void SetInputArrayName_29(byte[] id0, int len0);
  public void SetInputArrayName(String id0)
  {
    byte[] bytes0 = id0.getBytes(StandardCharsets.UTF_8);
    SetInputArrayName_29(bytes0, bytes0.length);
  }

  private native byte[] GetInputArrayName_30();
  public String GetInputArrayName()
  {
    return new String(GetInputArrayName_30(), StandardCharsets.UTF_8);
  }

  public vtkConstrained2DLayoutStrategy() { super(); }

  public vtkConstrained2DLayoutStrategy(long id) { super(id); }
