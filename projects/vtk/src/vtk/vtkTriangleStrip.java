// java wrapper for vtkTriangleStrip object
//
...
public class vtkTriangleStrip extends vtkCell
{
  ...
  public vtkTriangleStrip() { super(); }

  public vtkTriangleStrip(long id) { super(id); }
