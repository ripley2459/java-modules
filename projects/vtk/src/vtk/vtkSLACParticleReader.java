// java wrapper for vtkSLACParticleReader object
//
...
public class vtkSLACParticleReader extends vtkPolyDataAlgorithm
{
  ...
  public vtkSLACParticleReader() { super(); }

  public vtkSLACParticleReader(long id) { super(id); }
