// java wrapper for vtkParametricKlein object
//
...
public class vtkParametricKlein extends vtkParametricFunction
{
  ...
  public vtkParametricKlein() { super(); }

  public vtkParametricKlein(long id) { super(id); }
