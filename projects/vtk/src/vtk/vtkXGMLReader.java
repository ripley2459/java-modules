// java wrapper for vtkXGMLReader object
//
...
public class vtkXGMLReader extends vtkUndirectedGraphAlgorithm
{
  ...
  public vtkXGMLReader() { super(); }

  public vtkXGMLReader(long id) { super(id); }
