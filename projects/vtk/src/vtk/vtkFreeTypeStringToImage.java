// java wrapper for vtkFreeTypeStringToImage object
//
...
public class vtkFreeTypeStringToImage extends vtkStringToImage
{
  ...
  private native void DeepCopy_6(vtkFreeTypeStringToImage id0);
  public void DeepCopy(vtkFreeTypeStringToImage id0)
  {
    DeepCopy_6(id0);
  }

  public vtkFreeTypeStringToImage() { super(); }

  public vtkFreeTypeStringToImage(long id) { super(id); }
