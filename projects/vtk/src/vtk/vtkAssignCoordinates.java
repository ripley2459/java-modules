// java wrapper for vtkAssignCoordinates object
//
...
public class vtkAssignCoordinates extends vtkPassInputTypeAlgorithm
{
  ...
  private native void SetJitter_10(boolean id0);
  public void SetJitter(boolean id0)
  {
    SetJitter_10(id0);
  }

  public vtkAssignCoordinates() { super(); }

  public vtkAssignCoordinates(long id) { super(id); }
