// java wrapper for vtkFlyingEdges2D object
//
...
public class vtkFlyingEdges2D extends vtkPolyDataAlgorithm
{
  ...
  public vtkFlyingEdges2D() { super(); }

  public vtkFlyingEdges2D(long id) { super(id); }
