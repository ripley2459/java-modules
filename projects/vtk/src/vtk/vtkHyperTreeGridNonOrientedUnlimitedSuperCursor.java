// java wrapper for vtkHyperTreeGridNonOrientedUnlimitedSuperCursor object
//
...
public class vtkHyperTreeGridNonOrientedUnlimitedSuperCursor extends vtkObject
{
  ...
  public vtkHyperTreeGridNonOrientedUnlimitedSuperCursor Clone()
  {
    long temp = Clone_4();

    if (temp == 0) return null;
    return (vtkHyperTreeGridNonOrientedUnlimitedSuperCursor)vtkObjectBase.JAVA_OBJECT_MANAGER.getJavaObject(temp);
  }
  ...
  private native boolean IsRealLeaf_29();
  public boolean IsRealLeaf()
  {
    return IsRealLeaf_29();
  }

  private native boolean IsRealLeaf_30(int id0);
  public boolean IsRealLeaf(int id0)
  {
    return IsRealLeaf_30(id0);
  }

  private native boolean IsVirtualLeaf_31();
  public boolean IsVirtualLeaf()
  {
    return IsVirtualLeaf_31();
  }

  private native boolean IsVirtualLeaf_32(int id0);
  public boolean IsVirtualLeaf(int id0)
  {
    return IsVirtualLeaf_32(id0);
  }

  private native double GetExtensivePropertyRatio_33();
  public double GetExtensivePropertyRatio()
  {
    return GetExtensivePropertyRatio_33();
  }

  private native double GetExtensivePropertyRatio_34(long id0);
  public double GetExtensivePropertyRatio(long id0)
  {
    return GetExtensivePropertyRatio_34(id0);
  }

  private native boolean IsRoot_35();
  public boolean IsRoot()
  {
    return IsRoot_35();
  }

  private native int GetLevel_36();
  public int GetLevel()
  {
    return GetLevel_36();
  }

  private native int GetLevel_37(int id0);
  public int GetLevel(int id0)
  {
    return GetLevel_37(id0);
  }

  private native int GetLastRealLevel_38();
  public int GetLastRealLevel()
  {
    return GetLastRealLevel_38();
  }

  private native int GetLastRealLevel_39(int id0);
  public int GetLastRealLevel(int id0)
  {
    return GetLastRealLevel_39(id0);
  }

  private native void ToChild_40(byte id0);
  public void ToChild(byte id0)
  {
    ToChild_40(id0);
  }

  private native void ToRoot_41();
  public void ToRoot()
  {
    ToRoot_41();
  }

  private native void ToParent_42();
  public void ToParent()
  {
    ToParent_42();
  }

  private native int GetNumberOfCursors_43();
  public int GetNumberOfCursors()
  {
    return GetNumberOfCursors_43();
  }

  public vtkHyperTreeGridNonOrientedUnlimitedSuperCursor() { super(); }

  public vtkHyperTreeGridNonOrientedUnlimitedSuperCursor(long id) { super(id); }
