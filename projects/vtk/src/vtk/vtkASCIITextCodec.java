// java wrapper for vtkASCIITextCodec object
//
...
public class vtkASCIITextCodec extends vtkTextCodec
{
  ...
  public vtkASCIITextCodec() { super(); }

  public vtkASCIITextCodec(long id) { super(id); }
