// java wrapper for vtkUndirectedGraphAlgorithm object
//
...
public class vtkUndirectedGraphAlgorithm extends vtkAlgorithm
{
  ...
  public vtkUndirectedGraph GetOutput(int id0)
  {
  ...
  public vtkUndirectedGraphAlgorithm() { super(); }

  public vtkUndirectedGraphAlgorithm(long id) { super(id); }
