// java wrapper for vtkPOutlineFilter object
//
...
public class vtkPOutlineFilter extends vtkPolyDataAlgorithm
{
  ...
  public vtkPOutlineFilter() { super(); }

  public vtkPOutlineFilter(long id) { super(id); }
