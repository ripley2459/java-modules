// java wrapper for vtkCellGridWriter object
//
...
public class vtkCellGridWriter extends vtkWriter
{
  ...
  public vtkCellGrid GetInput(int id0)
  {
  ...
  public vtkCellGridWriter() { super(); }

  public vtkCellGridWriter(long id) { super(id); }
