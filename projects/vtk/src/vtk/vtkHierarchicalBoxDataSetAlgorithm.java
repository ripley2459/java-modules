// java wrapper for vtkHierarchicalBoxDataSetAlgorithm object
//
...
public class vtkHierarchicalBoxDataSetAlgorithm extends vtkAlgorithm
{
  ...
  public vtkHierarchicalBoxDataSet GetOutput(int id0)
  {
  ...
  public vtkHierarchicalBoxDataSetAlgorithm() { super(); }

  public vtkHierarchicalBoxDataSetAlgorithm(long id) { super(id); }
