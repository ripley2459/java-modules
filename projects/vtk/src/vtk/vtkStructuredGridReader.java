...
public class vtkStructuredGridReader extends vtkDataReader
{
  ...
  private native void SetOutput_6(vtkStructuredGrid id0);
  public void SetOutput(vtkStructuredGrid id0)
  {
    SetOutput_6(id0);
  }
  ...
  public vtkStructuredGridReader() { super(); }

  public vtkStructuredGridReader(long id) { super(id); }
