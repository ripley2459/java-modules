// java wrapper for vtkHyperTreeGridOrientedGeometryCursor object
//
...
public class vtkHyperTreeGridOrientedGeometryCursor extends vtkObject
{
  ...
  public vtkHyperTreeGridOrientedGeometryCursor Clone()
  {
    long temp = Clone_4();
  ...
  private native void Initialize_6(vtkHyperTreeGridOrientedGeometryCursor id0);
  public void Initialize(vtkHyperTreeGridOrientedGeometryCursor id0)
  {
    Initialize_6(id0);
  }
  ...
  public vtkHyperTreeGridOrientedGeometryCursor() { super(); }

  public vtkHyperTreeGridOrientedGeometryCursor(long id) { super(id); }
