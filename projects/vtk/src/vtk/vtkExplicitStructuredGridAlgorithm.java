// java wrapper for vtkExplicitStructuredGridAlgorithm object
//
...
public class vtkExplicitStructuredGridAlgorithm extends vtkAlgorithm
{
  ...
  public vtkExplicitStructuredGrid GetOutput(int id0)
  {
  ...
  private native long GetExplicitStructuredGridInput_9(int id0);
  public vtkExplicitStructuredGrid GetExplicitStructuredGridInput(int id0)
  {
    long temp = GetExplicitStructuredGridInput_9(id0);
  ...
  public vtkExplicitStructuredGridAlgorithm() { super(); }

  public vtkExplicitStructuredGridAlgorithm(long id) { super(id); }
