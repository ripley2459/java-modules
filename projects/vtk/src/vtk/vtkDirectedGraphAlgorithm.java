// java wrapper for vtkDirectedGraphAlgorithm object
//
...
public class vtkDirectedGraphAlgorithm extends vtkAlgorithm
{
  ...
  public vtkDirectedGraph GetOutput(int id0)
  {
  ...
  public vtkDirectedGraphAlgorithm() { super(); }

  public vtkDirectedGraphAlgorithm(long id) { super(id); }
