// java wrapper for vtkBiQuadraticQuad object
//
...
public class vtkBiQuadraticQuad extends vtkNonLinearCell
{
  ...
  private native int TriangulateLocalIds_11(int id0,vtkIdList id1);
  public int TriangulateLocalIds(int id0,vtkIdList id1)
  {
    return TriangulateLocalIds_11(id0,id1);
  }
  ...
  public vtkBiQuadraticQuad() { super(); }

  public vtkBiQuadraticQuad(long id) { super(id); }
