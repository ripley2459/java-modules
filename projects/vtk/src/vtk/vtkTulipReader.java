// java wrapper for vtkTulipReader object
//
...
public class vtkTulipReader extends vtkUndirectedGraphAlgorithm
{
  ...
  public vtkTulipReader() { super(); }

  public vtkTulipReader(long id) { super(id); }
