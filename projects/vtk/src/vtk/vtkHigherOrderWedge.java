...
public class vtkHigherOrderWedge extends vtkNonLinearCell
{
  ...
  private native void SetOrder_21(int id0,int id1,int id2,long id3);
  public void SetOrder(int id0,int id1,int id2,long id3)
  {
    SetOrder_21(id0,id1,id2,id3);
  }
