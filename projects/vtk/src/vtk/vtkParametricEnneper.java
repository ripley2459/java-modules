// java wrapper for vtkParametricEnneper object
//
...
public class vtkParametricEnneper extends vtkParametricFunction
{
  ...
  public vtkParametricEnneper() { super(); }

  public vtkParametricEnneper(long id) { super(id); }
