// java wrapper for vtkNewickTreeReader object
//
...
public class vtkNewickTreeReader extends vtkDataReader
{
  ...
  public vtkNewickTreeReader() { super(); }

  public vtkNewickTreeReader(long id) { super(id); }
