// java wrapper for vtkLabelHierarchyAlgorithm object
//
...
public class vtkLabelHierarchyAlgorithm extends vtkAlgorithm
{
  ...
  public vtkLabelHierarchy GetOutput(int id0)
  {
  ...
  private native long GetLabelHierarchyInput_9(int id0);
  public vtkLabelHierarchy GetLabelHierarchyInput(int id0)
  {
    long temp = GetLabelHierarchyInput_9(id0);
  ...
  public vtkLabelHierarchyAlgorithm() { super(); }

  public vtkLabelHierarchyAlgorithm(long id) { super(id); }
