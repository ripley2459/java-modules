// java wrapper for vtkQuadraticWedge object
//
...
public class vtkQuadraticWedge extends vtkNonLinearCell
{
  ...
  public vtkQuadraticWedge() { super(); }

  public vtkQuadraticWedge(long id) { super(id); }
