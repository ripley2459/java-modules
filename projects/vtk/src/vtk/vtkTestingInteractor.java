// java wrapper for vtkTestingInteractor object
//
...
public class vtkTestingInteractor extends vtkRenderWindowInteractor
{
  ...
  public vtkTestingInteractor() { super(); }

  public vtkTestingInteractor(long id) { super(id); }
