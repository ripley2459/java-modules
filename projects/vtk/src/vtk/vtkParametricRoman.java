// java wrapper for vtkParametricRoman object
//
...
public class vtkParametricRoman extends vtkParametricFunction
{
  ...
  private native void SetRadius_5(double id0);
  public void SetRadius(double id0)
  {
    SetRadius_5(id0);
  }

  private native double GetRadius_6();
  ...
  public vtkParametricRoman() { super(); }

  public vtkParametricRoman(long id) { super(id); }
