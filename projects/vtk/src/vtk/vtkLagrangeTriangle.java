// java wrapper for vtkLagrangeTriangle object
//
...
public class vtkLagrangeTriangle extends vtkHigherOrderTriangle
{
  ...
  public vtkLagrangeTriangle() { super(); }

  public vtkLagrangeTriangle(long id) { super(id); }
