// java wrapper for vtkCardinalSpline object
//
...
public class vtkCardinalSpline extends vtkSpline
{
  ...
  public vtkCardinalSpline() { super(); }

  public vtkCardinalSpline(long id) { super(id); }
