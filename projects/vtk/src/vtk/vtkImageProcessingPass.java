// java wrapper for vtkImageProcessingPass object
//
...
public class vtkImageProcessingPass extends vtkOpenGLRenderPass
{
  ...
  public vtkImageProcessingPass() { super(); }

  public vtkImageProcessingPass(long id) { super(id); }
