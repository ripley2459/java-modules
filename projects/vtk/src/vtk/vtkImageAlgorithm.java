// java wrapper for vtkImageAlgorithm object
//
...
public class vtkImageAlgorithm extends vtkAlgorithm
{
  ...
  private native long GetImageDataInput_11(int id0);
  public vtkImageData GetImageDataInput(int id0)
  {
    long temp = GetImageDataInput_11(id0);
  ...
  public vtkImageAlgorithm() { super(); }

  public vtkImageAlgorithm(long id) { super(id); }
