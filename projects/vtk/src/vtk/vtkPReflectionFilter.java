// java wrapper for vtkPReflectionFilter object
//
...
public class vtkPReflectionFilter extends vtkReflectionFilter
{
  ...
  public vtkPReflectionFilter() { super(); }

  public vtkPReflectionFilter(long id) { super(id); }
