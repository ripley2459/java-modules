// java wrapper for vtkVertex object
//
...
public class vtkVertex extends vtkCell
{
  ...
  private native void Clip_10(double id0,vtkDataArray id1,vtkIncrementalPointLocator id2,vtkCellArray id3,vtkPointData id4,vtkPointData id5,vtkCellData id6,long id7,vtkCellData id8,int id9);
  ...
  {
    Clip_10(id0,id1,id2,id3,id4,id5,id6,id7,id8,id9);
  }

  private native int Inflate_11(double id0);
  public int Inflate(double id0)
  {
    return Inflate_11(id0);
  }
  ...
  private native int GetParametricCenter_14(double id0[]);
  public int GetParametricCenter(double id0[])
  {
    return GetParametricCenter_14(id0);
  }
  ...
  public vtkVertex() { super(); }

  public vtkVertex(long id) { super(id); }
