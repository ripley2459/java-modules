// java wrapper for vtkMarchingCubes object
//
...
public class vtkMarchingCubes extends vtkPolyDataAlgorithm
{
  ...
  public vtkMarchingCubes() { super(); }

  public vtkMarchingCubes(long id) { super(id); }
