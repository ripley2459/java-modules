// java wrapper for vtkVtkJSViewNodeFactory object
//
...
public class vtkVtkJSViewNodeFactory extends vtkViewNodeFactory
{
  ...
  public vtkVtkJSViewNodeFactory() { super(); }

  public vtkVtkJSViewNodeFactory(long id) { super(id); }
