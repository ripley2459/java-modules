...
public class vtkServerSocket extends vtkSocket
{
  ...
  private native int CreateServer_4(int id0);
  public int CreateServer(int id0)
  {
    return CreateServer_4(id0);
  }

  private native long WaitForConnection_5(long id0);
  public vtkClientSocket WaitForConnection(long id0)
  {
    long temp = WaitForConnection_5(id0);

    if (temp == 0) return null;
    return (vtkClientSocket)vtkObjectBase.JAVA_OBJECT_MANAGER.getJavaObject(temp);
  }

  private native int GetServerPort_6();
  public int GetServerPort()
  {
    return GetServerPort_6();
  }
