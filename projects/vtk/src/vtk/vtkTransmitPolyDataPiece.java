// java wrapper for vtkTransmitPolyDataPiece object
//
...
public class vtkTransmitPolyDataPiece extends vtkPolyDataAlgorithm
{
  ...
  public vtkTransmitPolyDataPiece() { super(); }

  public vtkTransmitPolyDataPiece(long id) { super(id); }
