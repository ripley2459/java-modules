// java wrapper for vtkAnnotationLayersAlgorithm object
//
...
public class vtkAnnotationLayersAlgorithm extends vtkAlgorithm
{
  ...
  public vtkAnnotationLayers GetOutput(int id0)
  {
  ...
  public vtkAnnotationLayersAlgorithm() { super(); }

  public vtkAnnotationLayersAlgorithm(long id) { super(id); }
