// java wrapper for vtkShrinkPolyData object
//
...
public class vtkShrinkPolyData extends vtkPolyDataAlgorithm
{
  ...
  public vtkShrinkPolyData() { super(); }

  public vtkShrinkPolyData(long id) { super(id); }
