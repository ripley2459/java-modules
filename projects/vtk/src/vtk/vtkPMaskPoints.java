// java wrapper for vtkPMaskPoints object
//
...
public class vtkPMaskPoints extends vtkMaskPoints
{
  ...
  public vtkPMaskPoints() { super(); }

  public vtkPMaskPoints(long id) { super(id); }
