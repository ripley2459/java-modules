// java wrapper for vtkInformationDoubleKey object
//
...
public class vtkInformationDoubleKey extends vtkInformationKey
{
  ...
  public vtkInformationDoubleKey MakeKey(String id0,String id1)
  {
    byte[] bytes0 = id0.getBytes(StandardCharsets.UTF_8);
  ...
  private native void Set_5(vtkInformation id0,double id1);
  public void Set(vtkInformation id0,double id1)
  {
    Set_5(id0,id1);
  }

  private native double Get_6(vtkInformation id0);
  public double Get(vtkInformation id0)
  {
    return Get_6(id0);
  }
  ...
  public vtkInformationDoubleKey() { super(); }

  public vtkInformationDoubleKey(long id) { super(id); }
