// java wrapper for vtkTableReader object
//
...
public class vtkTableReader extends vtkDataReader
{
  ...
  public vtkTableReader() { super(); }

  public vtkTableReader(long id) { super(id); }
