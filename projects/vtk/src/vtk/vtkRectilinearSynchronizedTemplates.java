...
public class vtkRectilinearSynchronizedTemplates extends vtkPolyDataAlgorithm
{
  ...
  private native void SetValue_17(int id0,double id1);
  public void SetValue(int id0,double id1)
  {
    SetValue_17(id0,id1);
  }

  private native double GetValue_18(int id0);
  public double GetValue(int id0)
  {
    return GetValue_18(id0);
  }

  private native void SetNumberOfContours_19(int id0);
  public void SetNumberOfContours(int id0)
  {
    SetNumberOfContours_19(id0);
  }

  private native long GetNumberOfContours_20();
  public long GetNumberOfContours()
  {
    return GetNumberOfContours_20();
  }

  private native void GenerateValues_21(int id0,double id1[]);
  public void GenerateValues(int id0,double id1[])
  {
    GenerateValues_21(id0,id1);
  }

  private native void GenerateValues_22(int id0,double id1,double id2);
  public void GenerateValues(int id0,double id1,double id2)
  {
    GenerateValues_22(id0,id1,id2);
  }
  ...
  private native void SetGenerateTriangles_25(int id0);
  public void SetGenerateTriangles(int id0)
  {
    SetGenerateTriangles_25(id0);
  }

  private native int GetGenerateTriangles_26();
  public int GetGenerateTriangles()
  {
    return GetGenerateTriangles_26();
  }

  private native void GenerateTrianglesOn_27();
  public void GenerateTrianglesOn()
  {
    GenerateTrianglesOn_27();
  }

  private native void GenerateTrianglesOff_28();
  public void GenerateTrianglesOff()
  {
    GenerateTrianglesOff_28();
  }

  private native void ComputeSpacing_29(vtkRectilinearGrid id0,int id1,int id2,int id3,int id4[],double id5[]);
  public void ComputeSpacing(vtkRectilinearGrid id0,int id1,int id2,int id3,int id4[],double id5[])
  {
    ComputeSpacing_29(id0,id1,id2,id3,id4,id5);
  }
