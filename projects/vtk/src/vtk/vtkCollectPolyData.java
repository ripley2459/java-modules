// java wrapper for vtkCollectPolyData object
//
...
public class vtkCollectPolyData extends vtkPolyDataAlgorithm
{
  ...
  public vtkCollectPolyData() { super(); }

  public vtkCollectPolyData(long id) { super(id); }
