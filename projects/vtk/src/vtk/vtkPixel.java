// java wrapper for vtkPixel object
//
...
public class vtkPixel extends vtkCell
{
  ...
  private native int Inflate_13(double id0);
  public int Inflate(double id0)
  {
    return Inflate_13(id0);
  }

  private native double ComputeBoundingSphere_14(double id0[]);
  public double ComputeBoundingSphere(double id0[])
  {
    return ComputeBoundingSphere_14(id0);
  }
  ...
  private native int TriangulateLocalIds_16(int id0,vtkIdList id1);
  public int TriangulateLocalIds(int id0,vtkIdList id1)
  {
    return TriangulateLocalIds_16(id0,id1);
  }

  private native void InterpolationFunctions_17(double id0[],double id1[]);
  public void InterpolationFunctions(double id0[],double id1[])
  {
    InterpolationFunctions_17(id0,id1);
  }

  private native void InterpolationDerivs_18(double id0[],double id1[]);
  public void InterpolationDerivs(double id0[],double id1[])
  {
    InterpolationDerivs_18(id0,id1);
  }

  private native void InterpolateFunctions_19(double id0[],double id1[]);
  public void InterpolateFunctions(double id0[],double id1[])
  {
    InterpolateFunctions_19(id0,id1);
  }

  private native void InterpolateDerivs_20(double id0[],double id1[]);
  public void InterpolateDerivs(double id0[],double id1[])
  {
    InterpolateDerivs_20(id0,id1);
  }

  private native int ComputeNormal_21(double id0[]);
  public int ComputeNormal(double id0[])
  {
    return ComputeNormal_21(id0);
  }

  public vtkPixel() { super(); }

  public vtkPixel(long id) { super(id); }
