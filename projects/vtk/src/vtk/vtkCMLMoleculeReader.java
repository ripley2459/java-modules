// java wrapper for vtkCMLMoleculeReader object
//
...
public class vtkCMLMoleculeReader extends vtkMoleculeAlgorithm
{
  ...
  public vtkCMLMoleculeReader() { super(); }

  public vtkCMLMoleculeReader(long id) { super(id); }
