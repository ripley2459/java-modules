// java wrapper for vtkXMLPTableWriter object
//
...
public class vtkXMLPTableWriter extends vtkXMLPDataObjectWriter
{
  ...
  public vtkXMLPTableWriter() { super(); }

  public vtkXMLPTableWriter(long id) { super(id); }
