// java wrapper for vtkTableWriter object
//
...
public class vtkTableWriter extends vtkDataWriter
{
  ...
  public vtkTableWriter() { super(); }

  public vtkTableWriter(long id) { super(id); }
