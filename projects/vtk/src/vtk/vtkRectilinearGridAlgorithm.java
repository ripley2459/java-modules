// java wrapper for vtkRectilinearGridAlgorithm object
//
...
public class vtkRectilinearGridAlgorithm extends vtkAlgorithm
{
  ...
  private native long GetRectilinearGridInput_9(int id0);
  public vtkRectilinearGrid GetRectilinearGridInput(int id0)
  {
    long temp = GetRectilinearGridInput_9(id0);
  ...
  public vtkRectilinearGridAlgorithm() { super(); }

  public vtkRectilinearGridAlgorithm(long id) { super(id); }
