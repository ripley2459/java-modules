// java wrapper for vtkArrayWriter object
//
...
public class vtkArrayWriter extends vtkWriter
{
  ...
  private native boolean Write_17(vtkArray id0,byte[] id1, int len1,boolean id2);
  public boolean Write(vtkArray id0,String id1,boolean id2)
  {
  ...
  private native byte[] Write_19(vtkArray id0,boolean id1);
  public String Write(vtkArray id0,boolean id1)
  {
    return new String(Write_19(id0,id1), StandardCharsets.UTF_8);
  }

  public vtkArrayWriter() { super(); }

  public vtkArrayWriter(long id) { super(id); }
