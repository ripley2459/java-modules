...
public class vtkArrayDataReader extends vtkArrayDataAlgorithm
{
  ...
  public vtkArrayData Read(String id0)
  {
    byte[] bytes0 = id0.getBytes(StandardCharsets.UTF_8);
  ...
  public vtkArrayDataReader() { super(); }

  public vtkArrayDataReader(long id) { super(id); }
