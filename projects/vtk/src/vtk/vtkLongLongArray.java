// java wrapper for vtkLongLongArray object
//
...
public class vtkLongLongArray extends vtkDataArray
{
  ...
  public vtkLongLongArray ExtendedNew()
  {
    ...
    return (vtkLongLongArray)vtkObjectBase.JAVA_OBJECT_MANAGER.getJavaObject(temp);
  }
  ...
  public vtkLongLongArray FastDownCast(vtkAbstractArray id0)
  {
  ...
  public vtkLongLongArray() { super(); }

  public vtkLongLongArray(long id) { super(id); }
