// java wrapper for vtkMatrixToLinearTransform object
//
...
public class vtkMatrixToLinearTransform extends vtkLinearTransform
{
  ...
  public vtkMatrixToLinearTransform() { super(); }

  public vtkMatrixToLinearTransform(long id) { super(id); }
