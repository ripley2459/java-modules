// java wrapper for vtkOMETIFFReader object
//
...
public class vtkOMETIFFReader extends vtkTIFFReader
{
  ...
  public vtkOMETIFFReader() { super(); }

  public vtkOMETIFFReader(long id) { super(id); }
