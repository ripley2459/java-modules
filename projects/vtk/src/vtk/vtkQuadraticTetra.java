// java wrapper for vtkQuadraticTetra object
//
...
public class vtkQuadraticTetra extends vtkNonLinearCell
{
  ...
  private native boolean StableClip_14(double id0,vtkDataArray id1,vtkIncrementalPointLocator id2,vtkCellArray id3,vtkPointData id4,vtkPointData id5,vtkCellData id6,long id7,vtkCellData id8,int id9);
  ...
  {
    return StableClip_14(id0,id1,id2,id3,id4,id5,id6,id7,id8,id9);
  }
  ...
  public vtkQuadraticTetra() { super(); }

  public vtkQuadraticTetra(long id) { super(id); }
