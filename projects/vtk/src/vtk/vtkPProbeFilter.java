// java wrapper for vtkPProbeFilter object
//
...
public class vtkPProbeFilter extends vtkCompositeDataProbeFilter
{
  ...
  public vtkPProbeFilter() { super(); }

  public vtkPProbeFilter(long id) { super(id); }
