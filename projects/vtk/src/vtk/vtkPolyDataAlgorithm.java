// java wrapper for vtkPolyDataAlgorithm object
//
...
public class vtkPolyDataAlgorithm extends vtkAlgorithm
{
  ...
  public vtkPolyData GetPolyDataInput(int id0)
  {
  ...
  public vtkPolyDataAlgorithm() { super(); }

  public vtkPolyDataAlgorithm(long id) { super(id); }
