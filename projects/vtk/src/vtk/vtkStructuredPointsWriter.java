// java wrapper for vtkStructuredPointsWriter object
//
...
public class vtkStructuredPointsWriter extends vtkDataWriter
{
  ...
  public vtkStructuredPointsWriter() { super(); }

  public vtkStructuredPointsWriter(long id) { super(id); }
