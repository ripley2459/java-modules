// java wrapper for vtkOutEdgeIterator object
//
...
public class vtkOutEdgeIterator extends vtkObject
{
  ...
  public vtkOutEdgeIterator() { super(); }

  public vtkOutEdgeIterator(long id) { super(id); }
