// java wrapper for vtkUniformGridAMRAlgorithm object
//
...
public class vtkUniformGridAMRAlgorithm extends vtkAlgorithm
{
  ...
  public vtkUniformGridAMR GetOutput(int id0)
  {
  ...
  public vtkUniformGridAMRAlgorithm() { super(); }

  public vtkUniformGridAMRAlgorithm(long id) { super(id); }
