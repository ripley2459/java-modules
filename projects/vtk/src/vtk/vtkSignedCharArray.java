...
public class vtkSignedCharArray extends vtkDataArray
{
  ...
  public vtkSignedCharArray ExtendedNew()
  {
    long temp = ExtendedNew_4();

    if (temp == 0) return null;
    return (vtkSignedCharArray)vtkObjectBase.JAVA_OBJECT_MANAGER.getJavaObject(temp);
  }
  ...
  public vtkSignedCharArray FastDownCast(vtkAbstractArray id0)
  {
  ...
  public vtkSignedCharArray() { super(); }

  public vtkSignedCharArray(long id) { super(id); }
