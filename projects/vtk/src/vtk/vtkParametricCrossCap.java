// java wrapper for vtkParametricCrossCap object
//
...
public class vtkParametricCrossCap extends vtkParametricFunction
{
  ...
  public vtkParametricCrossCap() { super(); }

  public vtkParametricCrossCap(long id) { super(id); }
