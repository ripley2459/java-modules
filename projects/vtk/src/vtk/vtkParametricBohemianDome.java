// java wrapper for vtkParametricBohemianDome object
//
...
public class vtkParametricBohemianDome extends vtkParametricFunction
{
  ...
  public vtkParametricBohemianDome() { super(); }

  public vtkParametricBohemianDome(long id) { super(id); }
