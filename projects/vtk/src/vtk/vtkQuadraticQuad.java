// java wrapper for vtkQuadraticQuad object
//
...
public class vtkQuadraticQuad extends vtkNonLinearCell
{
  ...
  public vtkQuadraticQuad() { super(); }

  public vtkQuadraticQuad(long id) { super(id); }
