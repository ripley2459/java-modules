// java wrapper for vtkStructuredGridWriter object
//
...
public class vtkStructuredGridWriter extends vtkDataWriter
{
  ...
  public vtkStructuredGrid GetInput(int id0)
  {
  ...
  public vtkStructuredGridWriter() { super(); }

  public vtkStructuredGridWriter(long id) { super(id); }
