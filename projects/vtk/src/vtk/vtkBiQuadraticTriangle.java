// java wrapper for vtkBiQuadraticTriangle object
//
...
public class vtkBiQuadraticTriangle extends vtkNonLinearCell
{
  ...
  private native double GetParametricDistance_15(double id0[]);
  public double GetParametricDistance(double id0[])
  {
    return GetParametricDistance_15(id0);
  }
  ...
  public vtkBiQuadraticTriangle() { super(); }

  public vtkBiQuadraticTriangle(long id) { super(id); }
