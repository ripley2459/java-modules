// java wrapper for vtkFacetReader object
//
...
public class vtkFacetReader extends vtkPolyDataAlgorithm
{
  ...
  public vtkFacetReader() { super(); }

  public vtkFacetReader(long id) { super(id); }
